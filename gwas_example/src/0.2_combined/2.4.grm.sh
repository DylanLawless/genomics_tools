...
plink2 \
	--bfile $wdir/geno/cohort.filt.group \
	--exclude range $processed/exclusion_regions_hg19.txt \
	--make-bed \
	--out $wdir/grm/cohort.filt.group.no_lrldr
...
plink2 \
	--bfile $wdir/grm/cohort.filt.group.no_lrldr \
...
plink2 \
	--bfile $wdir/grm/cohort.filt.group.no_lrldr \
	--extract $wdir/grm/cohort.filt.group.no_lrldr.prune.in \
	--make-bed --out $wdir/grm/cohort.filt.group.no_lrldr.pruned

# PCA
# this takes apporx 10 minutes on 32 threads, 70 minutes on this dataset on ~18 thread

/work/gr-fe/username/tool/gcta64 \
	--bfile $wdir/grm/cohort.filt.group.no_lrldr.pruned \
	--autosome --make-grm \
	--out $wdir/grm/cohort.filt.group.grm \
	--thread-num 24

/work/gr-fe/username/tool/gcta64 \
	--grm $wdir/grm/cohort.filt.group.grm \
	--pca 20 \
	--out $wdir/grm/cohort.filt.group.pca \
	--thread-num 24
