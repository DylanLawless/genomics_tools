#!/bin/bash
#SBATCH --job-name=1.1.replace_gen_chr
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=22
#SBATCH --time=01:00:00
#SBATCH --mem=30gb
#SBATCH -o ./log/1.1.replace_gen_chr.%J.out
#SBATCH -e ./log/1.1.replace_gen_chr.%J.err
...
for i in {1..22}
    do
        sed -i "s/^---/$i/g" CONTROL.QC_chr$i.pos*impute2 &&
