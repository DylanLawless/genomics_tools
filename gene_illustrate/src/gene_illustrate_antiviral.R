...
df_uniprot <- readGFF("../data/uniprot_OAS1_P00973.gff")
df_uniprot <- readGFF("../data/uniprot_HUMAN_Q9BYX4_IFIH1.gff")
df_uniprot <- readGFF("../data/uniprot_HUMAN_Q92985_IRF7.gff")
df_uniprot <- readGFF("../data/uniprot_HUMAN_Q7Z434_MAVS.gff")
