...
df_uniprot <- readGFF("../data/uniprot_stat3_HUMAN_P40763.gff")
...
# Import variants ----
variants <- read.csv("../data/leiding2022jaci_stat3_tableE3.tsv", stringsAsFactors = FALSE, header = TRUE, sep="\t")

variants <- variants %>% filter(symbol == "STAT3") %>%
